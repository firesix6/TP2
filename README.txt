...
4- pour le cas de fermé, c'est un test d'etat car l'information principale est l'etat interne de la classe Jeu 
...
-> on veut savoir si le joueur ne touche pas les des apres, on peut dire que c un test d'interaction 
